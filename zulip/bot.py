...
BOT_MAIL = "raj-bot@chat.zulip.org"

class ZulipBot(object):
	def __init__(self):
		self.client = zulip.Client(site="https://rajorg.zulipchat.com/api/")
		self.subscribe_all()
	...
	def process(self, msg):
		...
		if content[0].lower() == "raj" or content[0] == "@**raj**":
		...
		elif "raj" in content and content[0] != "raj":
			self.client.send_message({
				"type": "stream",
				"subject": msg["subject"],
				"to": msg["display_recipient"],
...
if __name__ == "__main__":
	try:
		...
		print("Thanks for using raj Bot. Bye!")
		sys.exit(0)